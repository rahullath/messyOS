// Complete Finance Data Fix Script
// Addresses: Double counting, crypto display, categorization, pot transfers
...
export class CompleteFinanceDataFixer {
  private supabase;
  private userId = '368deac7-8526-45eb-927a-6a373c95d8c6'; // Your user ID
  ...
  async executeCompleteFix() {
    ...
    try {
      ...
      // Step 2: Import crypto holdings properly
      await this.importCryptoHoldings();
      
      // Step 3: Import bank transactions (excluding pot transfers)
      await this.importBankTransactions();
      
      // Step 4: Import manual expenses (avoiding duplicates)
  ...
  private async cleanupAllFinanceData() {
  ...
  private async importCryptoHoldings() {
  ...
  private async importBankTransactions() {
    ...
    // Sample bank transactions from your CSV (excluding pot transfers)
    const bankTransactions = [
      ...
      { date: '2025-04-08', description: 'UPIOUT mkretailcompany', amount: 3481.50, category: 'Food & Grocery', subcategory: 'MK Retail' },
      ...
      { date: '2025-04-19', description: 'UPIOUT pawsome718367.rzp@rxairt', amount: 1535.40, category: 'Pet Care', subcategory: 'Food' },
      ...
      { date: '2025-04-06', description: 'UPIOUT yulu563891.rzp@rxairtel', amount: 2.40, category: 'Transportation', subcategory: 'Yulu' },
      ...
      // ATM withdrawals
      { date: '2025-03-24', description: 'TO ATM/508312782535/152 ELDAMS ROAD', amount: 4000, category: 'Cash Withdrawal', subcategory: 'ATM' },
  ...
  private async importManualExpenses() {
    console.log('📝 Importing manual expenses (non-duplicates only)...');
    
    // Manual expenses from your expenses.txt that aren't covered by bank transactions
...
export async function runCompleteFinanceDataFix() {
